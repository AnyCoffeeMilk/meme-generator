...
export default function Home() {
  ...
  return (
    <main className="flex-1 lg:w-[1024px] grid grid-rows-[auto_1fr] gap-16 py-16 font-mono">
      <div className="font-mono grid gap-4">
        <h1 className="text-6xl font-extrabold tracking-widest text-center">MemeGen</h1>
        <h2 className="text-2xl text-fgSecondary text-center">Generate Meme base on keywords and image you provided.</h2>
      </div>
      ...
      {loading && <p className="text-center text-3xl font-bold">Generating...</p>}
      {result  && (
